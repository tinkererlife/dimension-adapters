...
// registry fees/courtyard uses. The state service binds context.api to the end
// of the requested range, so historical chunks use the registry state that was
// active at that time instead of today's membership.
